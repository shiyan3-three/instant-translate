...
from poc.poc_agent_memory_transfer import evaluate_format, normalize_surface
...
from poc.poc_reference_injection import _percentile, _send_request, estimate_tokens
...
def find_latest_baseline(root: Path = Path("poc/results")) -> Path:
    candidates = [
        path
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--dataset", default="poc/data/agent_strategy_transfer_dataset.json")
    parser.add_argument("--translation-dataset", default="poc/data/reference_poc_dataset.json")
