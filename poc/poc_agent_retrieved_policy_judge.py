...
from poc.poc_agent_bootstrap_review import (
    aggregate_reviews,
    load_result_mapping,
    load_scored_reviews,
)
from poc.poc_agent_memory_transfer import extract_json_object
from poc.poc_agent_retrieved_policy import GROUPS
from poc.poc_reference_injection import _send_request
...
def find_latest_final_results(root: Path = Path("poc/results")) -> Path:
    candidates = [
        path
